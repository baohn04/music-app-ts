...
(function ($) {
  ...
  var music = {
    ...
    More: function () {
      ...
      $(document).on(
        "click",
        "#playlist-wrap ul li .action .que_more",
        function (e) {
          e.preventDefault();
          e.stopImmediatePropagation();
          $("#playlist-wrap ul li .action .que_more")
      ...
      $(document).on("click", function (e) {
        if (
          !$(e.target).closest(".more_option").length &&
          !$(e.target).closest(".action").length
        ) {
          $("#playlist-wrap .more_option").removeClass("open_option");
        }
        if (
          !$(e.target).closest("#playlist-wrap").length &&
          !$(e.target).closest(".jp_queue_wrapper").length &&
          !$(e.target).closest(".player_left").length
        ) {
          $("#playlist-wrap").hide();
        }
      });
